(() => {
  ...
  function installWorker() {
    ...
    state.worker = new Worker("worker.js?v=1");
  ...
  function loadDemo() {
    const players = [
      { account: "Oops.7777", displayName: "Red Circle Enjoyer", profession: "Virtuoso", encounters: 3, dps: 28700, deaths: 5, downs: 8, breakbar: 1230, resurrects: 0, mechanicScorePerLog: 5.3, distance: 314, distanceWeight: 1 },
      { account: "Greed.9001", displayName: "Parse Goblin", profession: "Soulbeast", encounters: 3, dps: 35100, deaths: 1, downs: 2, breakbar: 360, resurrects: 0, mechanicScorePerLog: 0.7, distance: 246, distanceWeight: 1 },
      { account: "Hammer.5555", displayName: "Bonk Department", profession: "Scrapper", encounters: 3, dps: 22100, deaths: 1, downs: 1, breakbar: 8340, resurrects: 2, mechanicScorePerLog: 1.3, distance: 96, distanceWeight: 1 },
      { account: "Medic.1234", displayName: "Definitely A Healer", profession: "Druid", encounters: 3, dps: 6500, deaths: 0, downs: 1, breakbar: 1920, resurrects: 18, mechanicScorePerLog: 0, distance: 112, distanceWeight: 1 },
      { account: "Stack.2468", displayName: "Tag Attachment", profession: "Chronomancer", encounters: 3, dps: 15600, deaths: 0, downs: 0, breakbar: 2760, resurrects: 3, mechanicScorePerLog: 0, distance: 54, distanceWeight: 1 },
    ];
