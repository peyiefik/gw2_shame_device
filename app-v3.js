(() => {
  ...
  function installWorker() {
    ...
    state.worker = new Worker("worker-v3.js?v=1");
  ...
  function loadDemo() {
    ...
    state.awards = [
      ...
      { icon: "⏩", title: "Quickness Outage", winner: players[2], stat: "87.4% average subgroup Quickness · provider average 94.6% · 3 Quickness logs", roast: "Lowest active-time-weighted Quickness uptime among detected Quickness providers — 7.2 percentage points below the provider average." },
      { icon: "⏱️", title: "Alacrity Outage", winner: players[3], stat: "89.2% average subgroup Alacrity · provider average 96.1% · 3 Alacrity logs", roast: "Lowest active-time-weighted Alacrity uptime among detected Alacrity providers — 6.9 percentage points below the provider average." },
